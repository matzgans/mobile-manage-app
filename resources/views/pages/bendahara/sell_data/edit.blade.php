            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-2xl font-bold">
                        {{ __('Ubah Data Penjualan') }}
                    </div>
                    <div class="grid gap-4 lg:grid-cols-2">
                        <div class="mt-4 w-full">
                            <form class="mx-auto max-w-full"
                                action="{{ route('bendahara.sell.update', ['sell' => $sell->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3 w-full">
                                    ...
                                    <div class="relative">
                                        <input
                                            ...
                                            id="code" name="code" type="string" value="{{ $sell->code }}"
                                ...
                                <div class="mb-3 w-full">
                                    ...
                                    <div class="relative">
                                        <input
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                            id="order" name="unit" type="number" value="{{ $sell->unit }}"
                                ...
                                <div class="mb-3 w-full">
                                    ...
                                    <div class="relative">
                                        <input
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                            id="price" name="price" type="number" value="{{ $sell->price }}"
