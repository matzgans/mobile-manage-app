                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-3 flex">
                        <div class="me-3 w-full">
                            ...
                            <form class="max-w-full" action="{{ route('sales.car.index') }}">
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                        class="block w-full rounded-lg border border-secondary bg-gray-50 p-4 ps-10 text-sm text-gray-900 focus:border-secondary focus:text-secondary focus:ring-secondary dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-secondary dark:focus:ring-secondary"
                            ...
                            @if ($cars)
                                @foreach ($cars as $key => $car)
                                    <tr class="border bg-white dark:border-gray-700 dark:bg-gray-800">
                                        ...
                                        <td class="px-6 py-4">
                                            {{ 'Rp ' . number_format((float) $car->price, 0, ',', '.') }}
                                        </td>
                                        <td class="flex items-center px-6 py-4">
                                            <a href="{{ route('sales.car.edit', ['car' => $car->id]) }}">
                                            ...
                                            <form id="delete-form-{{ $car->id }}" style="display: none;"
                                                action="{{ route('sales.car.destroy', ['car' => $car->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
