                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid gap-4 lg:grid-cols-2">
                        <div class="mt-4 w-full">
                            <form class="mx-auto max-w-full" action="{{ route('sales.car.update', ['car' => $car->id]) }}"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="mb-3 w-full">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            value="{{ $car->code }}" placeholder="Masukan Kode Barang">
                                    </div>
                                </div>
                                <div class="mb-3 w-full">
                                    <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            value="{{ $car->year }}" placeholder="name@flowbite.com">
                                    </div>
                                </div>
                                <div class="mb-3 w-full">
                                    <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"
                                    ...
                                    <div class="relative">
                                        ...
                                        <input
                                            ...
                                            value="{{ $car->price }}" placeholder="masukan angka tanpa titik">
                                    </div>
                                </div>
