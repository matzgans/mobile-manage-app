                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-3 flex">
                        <div class="me-3 w-full">
                            <form class="max-w-full" action="{{ route('sparepart.buy.index') }}">
                        ...
                        <a class="dark:focus:ring-[#3b5998]/55 text-nowrap mb-2 me-2 inline-flex items-center rounded-lg bg-secondary px-5 py-3.5 text-center text-sm font-medium text-white hover:bg-orange-400 focus:outline-none focus:ring-4 focus:ring-[#3b5998]/50"
                            href="{{ route('sparepart.buy.create') }}">
                                ...
                                @foreach ($buys as $key => $buy)
                                    <tr class="border bg-white dark:border-gray-700 dark:bg-gray-800">
                                        ...
                                        <td class="flex items-center px-6 py-4">
                                            <a href="{{ route('sparepart.buy.edit', ['buy' => $buy->id]) }}">
                                            ...
                                            <a href="javascript:void(0);" onclick="confirmDelete({{ $buy->id }})">
                                            ...
                                            <form id="delete-form-{{ $buy->id }}" style="display: none;"
                                                action="{{ route('sparepart.buy.destroy', ['buy' => $buy->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            </form>
